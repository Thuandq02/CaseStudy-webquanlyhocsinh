...
<br><br><br>
<h1 style="text-align: center;color: #343a40">Danh Sách Môn Học</h1>
<br><br><br>
<table class="table table-striped">
    <thead class="thead-dark">
    <tr>
        <th style="background-color: #343a40">ID</th>
        <th scope="col" style="background-color: #343a40">Môn Học</th>
    </tr>
    </thead>
    <tbody>
    <?php foreach ($subjects as $key => $value): ?>
        <tr>
            <th><?php echo $value->getIdSubject(); ?></th>
            <th><?php echo $value->getSubjectName(); ?></th>
        </tr>
    <?php endforeach; ?>
    </tbody>
</table>
