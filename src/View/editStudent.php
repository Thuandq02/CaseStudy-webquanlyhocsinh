...
<form method="post">
    <form method="POST" enctype="multipart/form-data">
        <table align="center" class="table" style="width: auto; border-radius: 15px">
            ...
            <tr>
                <td colspan="2" align="center"><h1>Sửa Học Sinh</h1></td>
            </tr>
            <tr>
                <td>Mã Lớp</td>
                <td>
            ...
            <tr>
                <td>Tên Học Sinh</td>
                <td><input type="text" class="form-control" name="name" placeholder="Enter name" value="<?php echo $students['NameStudent']?>"</td>
            </tr>
            <tr>
                <td>Giới tính</td>
                <td>
            ...
            <tr>
                <td>Ngày Sinh</td>
                <td><input type="date" class="form-control" name="date" placeholder="Enter date" value="<?php echo $students['Date']?>"</td>
            </tr>
            <tr>
                <td>Địa Chỉ</td>
                <td><input type="text" class="form-control" name="address" placeholder="Enter address" value="<?php echo $students['Address']?>"</td>
            </tr>
            <tr>
                <td>
